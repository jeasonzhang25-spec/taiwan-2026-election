        ...
        <div className="grid gap-5 p-5 sm:p-6 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
            <div className="mb-2 flex flex-wrap items-center gap-2">
              <span className={`inline-flex items-center gap-1.5 rounded-full bg-white/[0.06] px-2.5 py-1 text-xs font-medium ${healthy ? "text-[#72D6A0]" : "text-[#F1C46B]"}`}>
              ...
              <span className="text-xs text-white/55">民調目錄核驗 {health.checkedAt}</span>
            </div>
            <h2 id="trust-title" className="text-[22px] font-semibold leading-8 tracking-tight text-white sm:text-2xl">每個數字都能追到來源，也看得到缺口</h2>
          ...
          <div className="flex flex-col gap-2 sm:flex-row lg:flex-col xl:flex-row">
            ...
            <a href="/roadmap" className="rounded-xl border border-white/15 bg-white/[0.06] px-4 py-2.5 text-center text-sm font-medium text-white hover:bg-white/10">查看完善清單</a>
          </div>
        </div>
      </div>
    </section>
