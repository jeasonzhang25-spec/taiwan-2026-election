        ...
        <div className="flex flex-col gap-4 text-xs text-white/55 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <a href="/" aria-label="島嶼選情首頁" className="inline-flex rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ink/30">
              <BrandLogo markSize={34} tone="dark" />
            </a>
            <nav className="mt-3 flex gap-4" aria-label="頁尾導覽">
              <a href="/data-status" className="text-white/65 underline decoration-white/20 underline-offset-4 hover:text-white">資料狀態</a>
              <a href="/sources" className="text-white/65 underline decoration-white/20 underline-offset-4 hover:text-white">來源台帳</a>
              <a href="/roadmap" className="text-white/65 underline decoration-white/20 underline-offset-4 hover:text-white">完善清單</a>
            </nav>
          </div>
